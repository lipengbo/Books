    ...
    if((getCookie("name")) && !document.getElementById("userMenu")){
        $.ajax({
            ...
            success: function (data, status) {
                ...
                user.find("li:first").append('<ul id="userMenu" class="dropdown-menu" style="display:none"><li><a href="/personal">个人中心<span class="fa fa-envelope pull-right"></span></a></li><li class="divider"></li><li><a href="/account">账号设置 <span class="glyphicon glyphicon-cog pull-right"></span></a></li><li class="divider"></li><li><a href="/logout" id="logout">安全退出 <span class="glyphicon glyphicon-log-out pull-right"></span></a></li></ul>');
                user.remove("li:even")
            },
        })
    }
        ...
        user.append('<li id="userInfo" class="dropdown"><a href="/login"><i class="fa fa-sign-in"></i>  登录</a></li>');
        user.append('<li><a href="/register"><i class="fa fa-pencil"></i>  注册</a></li>');
    }
});
